...
% PATHS
basepath = 'C:\Users\Daniele\Desktop\Daniele\1. Università\2. Magistrale\1° ANNO 2° SEMESTRE\Computer Vision\Progetto\handsonbow (matlabCode)\handsonbow\';
wdir = pwd;
...
for i=1:length(desc_train) 
    ...
    H = histcounts(visword,[1:nwords_codebook]);
