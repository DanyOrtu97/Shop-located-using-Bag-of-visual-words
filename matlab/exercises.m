...
if do_split_sets    
    data = create_dataset_split_structure(fullfile(basepath, 'img/images/', dataset_dir),num_train_img,num_test_img ,file_ext);
    save(fullfile(basepath,'img/images',dataset_dir,file_split),'data');
else
    load(fullfile(basepath,'img/images',dataset_dir,file_split));
end
...
if do_feat_extraction   
    extract_sift_features(fullfile('/media/andrea/Dati2/CV_Proj/handsonbow/','img/images',dataset_dir),desc_name)    
end
